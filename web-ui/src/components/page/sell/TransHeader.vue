    ...
    <div class="table">
        ...
        <div class="container">
            ...
            <el-table :data="data" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="count" label="count" sortable width="150">
                </el-table-column>
                <el-table-column prop="sumamt" label="sumamt" width="200">
                </el-table-column>
                <el-table-column prop="dizdate" label="dizdate" width="200">
                </el-table-column>
                ...
                <el-table-column label="操作" width="300">
                    <template slot-scope="scope">
                        ...
                        <el-button size="small" type="primary" @click="handleTrack(scope.$index, scope.row)">消费信息</el-button>
                    </template>
                </el-table-column>
            </el-table>
        ...
        <el-dialog title="详细信息" :visible.sync="detailVisible" width="30%">
            <el-form ref="form" :model="form" label-width="50px">
                ...
                <el-form-item label="   sumamt"label-width="70px">
                    <el-input v-model="form.sumamt"></el-input>
                </el-form-item>
                <el-form-item label="dizdate"label-width="70px">
                    <el-input v-model="form.dizdate"></el-input>
                </el-form-item>
            </el-form>
        ...
        methods: {
            ...
            getData() {
                ...
                if (process.env.NODE_ENV === 'development') {
                    ...
                    this.url = 'api/api/transheader/list';  //这个可以请求到后端的
                };
